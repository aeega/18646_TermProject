...
/*
 * CJH Notes
 * Make sure you always include what you use. Here you're using printf and
 * rdtsc, so you need stdio.h and time.h
 */
...
// void ced_stages345(float **dest, float **D_new, float **D_new_temp, float *D,
// float **thresh, float **theta_new_temp, float *Theta, int rows, int cols){
